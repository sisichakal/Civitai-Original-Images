...
(function() {
    ...
    /**
     * Check if the current URL is allowed for processing
     */
    function isUrlAllowed() {
        const sPath = window.location.pathname;

        // Allow explicit paths including single image pages
        if (sPath.startsWith('/images') || sPath.startsWith('/models/') || sPath.startsWith('/posts')) {
            return true;
        }

        // Default allow for root and user profiles
        return sPath === '/' || sPath.startsWith('/user/');
    }

    /**
     * Check if we are on a single image detail page
     */
    ...
    /**
     * Convert optimized URL to original URL (UK English variable name)
     */
    ...
    /**
     * Calculate megapixels from image dimensions (UK English variable names)
     */
    ...
    /**
     * Get badge colour based on megapixels (UK English variable names)
     */
    ...
    /**
     * Create megapixel badge (UK English variable names)
     */
    ...
    /**
     * Inject custom CSS to fix layout issues globally
     */
    ...
    /**
     * Remove specific unwanted badges/elements from the DOM
     */
    ...
    /**
     * Remove empty containers left by ad blockers
     */
    ...
    /**
     * Process a single image element (UK English variable names)
     */
    function processImage(oImg) {
        ...
        oTempImg.onload = function() {
            // Final check just in case, to ensure it's not a tiny image with a big source
